...
export 'package:e_commerce_getx/data/models/on_boarding.dart';
export 'package:e_commerce_getx/view/pages/on_boarding_page.dart';
export 'package:e_commerce_getx/core/constants/images_assets.dart';
